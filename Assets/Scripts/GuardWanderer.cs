...
public class GuardWanderer : MonoBehaviour {
    ...
    void Start()
    {
        ...
        dot = new Vector3(Random.Range(PatrolPoint.transform.position.x - range, PatrolPoint.transform.position.x + range), Random.Range(PatrolPoint.transform.position.y - range, PatrolPoint.transform.position.y + range), 0);
        ...
        Carts = FindGameObjectsWithTags(new string[] { "Enemy"});
    }
    ...
    void Update()
    {
        ...
        if (Cel != null)
        {
            ...
            if (Vector3.Distance(Cel.transform.position, transform.position) > 3f)
            {
                ...
                {
                    transform.position = Vector3.MoveTowards(transform.position, dot, 2 * Time.deltaTime);
                }
    ...
    public GameObject FindClosestEnemy()
    {
        ...
        gos = FindGameObjectsWithTags(new string[] { "Enemy" });
